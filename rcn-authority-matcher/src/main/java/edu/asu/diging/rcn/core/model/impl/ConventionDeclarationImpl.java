...
public class ConventionDeclarationImpl implements ConventionDeclaration {
    ...
    @GenericGenerator(name = "conDecl_id_generator",    
    ...
    /* (non-Javadoc)
     * @see edu.asu.diging.rcn.core.model.impl.ConventionDeclaration#setId(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see edu.asu.diging.rcn.core.model.impl.ConventionDeclaration#getAbbreviation()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see edu.asu.diging.rcn.core.model.impl.ConventionDeclaration#setAbbreviation(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see edu.asu.diging.rcn.core.model.impl.ConventionDeclaration#setCitation(java.lang.String)
     */
    @Override
